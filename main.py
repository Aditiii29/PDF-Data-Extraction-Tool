...
from src.table_reconstructor import group_cells_by_rows, rows_to_2d_list, build_dataframe
...
def main():
    ...
    for page_idx, page in enumerate(pdf.pages, start=1):
        ...
        print(f"\nPage {page_idx}: Words extracted = {len(page_words)}")
        ...
        print(f"Page {page_idx}: {len(tables)} tables found")
        
        # -----------------------------
        # Table-wise processing
        # -----------------------------
